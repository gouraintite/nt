        ...
        <div className="m-auto space-y-8 md:w-8/12 lg:w-6/12 xl:w-6/12">
          <div className="rounded-lg border-none bg-white dark:bg-gray-800 dark:border-gray-700 shadow-2xl shadow-dark/32 backdrop-blur-2xl">
            <div className="px-6 py-2 sm:p-9">
              ...
              <h2 className="mb-4 text-xl font-bold text-gray-800 dark:text-white">Inscrivez-vous</h2>
              <form action="" className="space-y-4">
                ...
                <div className="space-y-2">
                  <label for="username" className="text-gray-600 dark:text-gray-300">Numéro de téléphone</label>
                  <input
                    type="tel"
                    name="tel"
                    id="tel"
                ...
                <div className="space-y-2">
                  <label for="username" className="text-gray-600 dark:text-gray-300">E-mail <span className='text-red/40'>(facultatif)</span></label>
                  <input
                    type="email"
                    name="email"
                    id="email"
                ...
                <label for="pwd" className="text-gray-600 dark:text-gray-300">Confirmer le mot de passe</label>
                ...
                <p className="border-t border-gray-100 dark:border-gray-700 pt-6 text-sm text-gray-500 dark:text-gray-400">
                  ...
                  <Link href="/connexion" className="text-primary">Connectez-vous</Link>
                </p>
              </form>
            </div>
          </div>
